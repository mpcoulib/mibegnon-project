...
import { getScholarshipById, getScholarshipIdsForStaticParams } from "@/lib/data/scholarships";

export const revalidate = 3600;

export async function generateStaticParams() {
  try {
    const rows = await getScholarshipIdsForStaticParams(200);
          ...
          <div className="space-y-4">
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 sticky top-20">
              ...
              <div className="mt-3 flex items-center gap-2">
                <SaveButton scholarshipId={s.id} initialSaved={isSaved} />
